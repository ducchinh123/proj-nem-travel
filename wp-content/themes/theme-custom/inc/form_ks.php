<div class="main-home ng-scope" ng-app="Contracting" ng-controller="homepage.ctrl">
  <div class="col-xs-12 no-padding">
    <div class="hero-container" id="hero-banner-home" data-href="#"
              ...
              <div class="col-xs-12 no-padding hero-form" id="hero-form">
                ...
                <div class="col-xs-12 search-form home-page">
                  <form action="" method="post">
                    <div class="row" id="rowsearchMobi">
                      <!-- ngIf: isShowBizAcc -->
                      <div class="col-xs-10 typeahead-container search-fullframe">
                        <div class="col-xs-12 no-padding v_field ">
                          ...
                          <span class="twitter-typeahead" style="position: relative; display: inline-block;">
                            <input id="searchText" style="padding-left: 50px; position: relative; vertical-align: top;"
                              type="text" class="form-control v_field__input search-input typeahead tt-input"
                              maxlength="200" placeholder="Bạn muốn ở khách sạn nào?" autocomplete="off" spellcheck="false"
                              dir="auto">
                      ...
                      <div class="col-xs-2 col-sm-2" style="text-align:center;">
                        <button type="submit" class="btn btn-action btn-block  search-form-button btn-big">
